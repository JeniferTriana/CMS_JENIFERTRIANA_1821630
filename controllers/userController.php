...
class userController extends User{
    ...
    public function update(){
        var_dump(parent::update_register($_POST) ? header('location: ?controller=user'): 'Error al actualizar');
    }


    //
    public function delete(){
         parent::delete_register($_GET) ? header('location: ?controller=user') : 'Error al eliminar';;
    }
